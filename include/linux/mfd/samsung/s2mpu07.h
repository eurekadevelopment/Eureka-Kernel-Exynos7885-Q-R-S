...
/*
 * s2mpu07.h - Driver for the s2mpu07
 *
...
#ifndef __S2MPU07_MFD_H__
#define __S2MPU07_MFD_H__
#include <linux/platform_device.h>
#include <linux/regmap.h>

#define MFD_DEV_NAME "s2mpu07"
/**
 * sec_regulator_data - regulator data
 * @id: regulator id
 * @initdata: regulator init data (contraints, supplies, ...)
 */
struct s2mpu07_regulator_data {
	int id;
...
struct s2mpu07_platform_data {
	...
	int num_regulators;
	struct	s2mpu07_regulator_data *regulators;
