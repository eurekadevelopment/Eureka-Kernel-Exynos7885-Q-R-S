...
/*
 * s2mpu08.h - Driver for the s2mpu08
 *
...
#ifndef __S2MPU08_MFD_H__
#define __S2MPU08_MFD_H__
...
struct s2mpu08_platform_data {
	...
	int num_regulators;
	struct	s2mpu08_regulator_data *regulators;
