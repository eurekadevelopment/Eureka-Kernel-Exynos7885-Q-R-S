 ...
 */
#define EXT4_IOC_GET_SDP_INFO     _IOR('l', 0x11, struct dek_arg_sdp_info)
#define EXT4_IOC_SET_SDP_POLICY   _IOW('l', 0x12, dek_arg_set_sdp_policy_t)
#define EXT4_IOC_SET_SENSITIVE    _IOW('l', 0x15, dek_arg_set_sensitive_t)
#define EXT4_IOC_SET_PROTECTED    _IOW('l', 0x16, dek_arg_set_protected_t)
#define EXT4_IOC_ADD_CHAMBER      _IOW('l', 0x17, dek_arg_add_chamber_t)
#define EXT4_IOC_REMOVE_CHAMBER   _IOW('l', 0x18, __u32)
