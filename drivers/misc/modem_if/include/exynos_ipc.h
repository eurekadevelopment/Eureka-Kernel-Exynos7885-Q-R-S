...
enum exynos_ch_id {
	...
	EXYNOS_CH_ID_RCS_0 = 236,    /*CH_RAW_CS_VT_DATA*/
	EXYNOS_CH_ID_RCS_1 = 237,    /*CH_RAW_CIQ_BRIDGE*/

	EXYNOS_CH_ID_PPT_0 = 238,    /*Mission-Critical Push to Talk*/
	EXYNOS_CH_ID_PPT_1 = 239,    /*Mission-Critical Push to Talk*/
