...
/*0*/	{V4L2_DV_BT_DMT_640X480P60,          640,  480, 60, FB_VMODE_NONINTERLACED, "640x480p@60"},
/*1*/	{V4L2_DV_BT_CEA_720X480P59_94,       720,  480, 59, FB_VMODE_NONINTERLACED, "720x480p@60"},
/*2*/	{V4L2_DV_BT_CEA_720X576P50,          720,  576, 50, FB_VMODE_NONINTERLACED, "720x576p@50"},
/*3*/	{V4L2_DV_BT_CEA_1280X720P50,	    1280,  720, 50, FB_VMODE_NONINTERLACED, "1280x720p@50"},
/*4*/	{V4L2_DV_BT_CEA_1280X720P60,	    1280,  720, 60, FB_VMODE_NONINTERLACED, "1280x720p@60"},
/*5*/	{V4L2_DV_BT_CEA_1920X1080P24,	    1920, 1080, 24, FB_VMODE_NONINTERLACED, "1920x1080p@24"},
/*6*/	{V4L2_DV_BT_CEA_1920X1080P25,	    1920, 1080, 25, FB_VMODE_NONINTERLACED, "1920x1080p@25"},
/*7*/	{V4L2_DV_BT_CEA_1920X1080P30,	    1920, 1080, 30, FB_VMODE_NONINTERLACED, "1920x1080p@30"},
/*8*/	{V4L2_DV_BT_CEA_1920X1080P50,	    1920, 1080, 50, FB_VMODE_NONINTERLACED, "1920x1080p@50"},
/*9*/	{V4L2_DV_BT_CEA_1920X1080P60,	    1920, 1080, 60, FB_VMODE_NONINTERLACED, "1920x1080p@60"},
/*10*/	{V4L2_DV_BT_CVT_2560X1440P60_ADDED, 2560, 1440, 60, FB_VMODE_NONINTERLACED, "2560x1440p@60"},
/*11*/	{V4L2_DV_BT_CEA_3840X2160P24,	    3840, 2160, 24, FB_VMODE_NONINTERLACED, "3840x2160p@24"},
/*12*/	{V4L2_DV_BT_CEA_3840X2160P25,	    3840, 2160, 25, FB_VMODE_NONINTERLACED, "3840x2160p@25"},
/*13*/	{V4L2_DV_BT_CEA_3840X2160P30,	    3840, 2160, 30, FB_VMODE_NONINTERLACED, "3840x2160p@30"},
/*14*/	{V4L2_DV_BT_CEA_3840X2160P50,	    3840, 2160, 50, FB_VMODE_NONINTERLACED, "3840x2160p@50"},
/*15*/	{V4L2_DV_BT_CVT_3840X2160P59_ADDED, 3840, 2160, 59, FB_VMODE_NONINTERLACED, "3840x2160p@59_RB"},
/*16*/	{V4L2_DV_BT_CEA_3840X2160P60,	    3840, 2160, 60, FB_VMODE_NONINTERLACED, "3840x2160p@60"},
/*17*/	{V4L2_DV_BT_CEA_4096X2160P24,	    4096, 2160, 24, FB_VMODE_NONINTERLACED, "4096x2160p@24"},
/*18*/	{V4L2_DV_BT_CEA_4096X2160P25,	    4096, 2160, 25, FB_VMODE_NONINTERLACED, "4096x2160p@25"},
/*19*/	{V4L2_DV_BT_CEA_4096X2160P30,	    4096, 2160, 30, FB_VMODE_NONINTERLACED, "4096x2160p@30"},
/*20*/	{V4L2_DV_BT_CEA_4096X2160P50,	    4096, 2160, 50, FB_VMODE_NONINTERLACED, "4096x2160p@50"},
/*21*/	{V4L2_DV_BT_CEA_4096X2160P60,	    4096, 2160, 60, FB_VMODE_NONINTERLACED, "4096x2160p@60"},
};
