 ...
 *	[19]REG_U: Single Still Capture (4:3)   : 4800X3600@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[20]REG_V: Single Still Capture (4:3)   : 2400X1800@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[21]REG_W: Single Still Capture (4:3)   : 2400X1352@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[22]REG_X: Single Still Capture (4:3)   : 2400X1168@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[23]REG_Y: Single Still Capture (4:3)   : 1800X1800@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[24]REG_Z: Single Still Capture (4:3)   : 4800X2700@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[25]REG_Z: Single Still Capture (4:3)   : 4800X2336@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 *	[26]REG_Z: Single Still Capture (4:3)   : 3600X3600@30 ,  MIPI lane: 4, MIPI data rate(Mbps/lane) Sensor: 2054
 */
...
//[19] REG_U: Single Still Capture (4:3)   : 4800X3600@30
const u32 sensor_imx576_setfile_B_4800X3600_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[20] REG_V: Single Still Capture (4:3)   : 2400X1800@30
const u32 sensor_imx576_setfile_B_2400X1800_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[21] REG_W: Single Still Capture (4:3)   : 2400X1352@30
const u32 sensor_imx576_setfile_B_2400X1352_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[22] REG_X: Single Still Capture (4:3)   : 2400X1168@30
const u32 sensor_imx576_setfile_B_2400X1168_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[23] REG_Y: Single Still Capture (4:3)   : 1800X1800@30
const u32 sensor_imx576_setfile_B_1800X1800_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[24] REG_Z: Single Still Capture (4:3)   : 4800X2700@30
const u32 sensor_imx576_setfile_B_4800X2700_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[25] REG_Z: Single Still Capture (4:3)   : 4800X2336@30
const u32 sensor_imx576_setfile_B_4800X2336_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[26] REG_Z: Single Still Capture (4:3)   : 3600X3600@30
const u32 sensor_imx576_setfile_B_3600X3600_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[19]REG_U: Single Still Capture (4:3): 4800X3600@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_4800X3600_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,             /*clock information - VTPXCK [MHz] */
	4316,
	6144,
};

//[20]REG_V: Single Still Capture (4:3): 2400X1800@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_2400X1800_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
//[21]REG_W: Single Still Capture (18.5:9): 2400X1352@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_2400X1352_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
//[22]REG_X: Single Still Capture (18.5:9): 2400X1168@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_2400X1168_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
//[23]REG_Y: Single Still Capture (18.5:9): 1800X1800@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_1800X1800_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
//[24]REG_Z: Single Still Capture (18.5:9): 4800X2700@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_4800X2700_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
//[25]REG_Z: Single Still Capture (18.5:9): 4800X2336@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_4800X2336_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
//[26]REG_Z: Single Still Capture (18.5:9): 3600X3600@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_B_3600X3600_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
static const u32 *sensor_imx576_setfiles_B[] = {
	...
	sensor_imx576_setfile_B_4800X3600_30fps,
	sensor_imx576_setfile_B_2400X1800_30fps,
	sensor_imx576_setfile_B_2400X1352_30fps,
	sensor_imx576_setfile_B_2400X1168_30fps,
	sensor_imx576_setfile_B_1800X1800_30fps,
	sensor_imx576_setfile_B_4800X2700_30fps,
	sensor_imx576_setfile_B_4800X2336_30fps,
	sensor_imx576_setfile_B_3600X3600_30fps,
};
...
static const u32 sensor_imx576_setfile_B_sizes[] = {
	...
	sizeof(sensor_imx576_setfile_B_4800X3600_30fps) / sizeof(sensor_imx576_setfile_B_4800X3600_30fps[0]),
	sizeof(sensor_imx576_setfile_B_2400X1800_30fps) / sizeof(sensor_imx576_setfile_B_2400X1800_30fps[0]),
	sizeof(sensor_imx576_setfile_B_2400X1352_30fps) / sizeof(sensor_imx576_setfile_B_2400X1352_30fps[0]),
	sizeof(sensor_imx576_setfile_B_2400X1168_30fps) / sizeof(sensor_imx576_setfile_B_2400X1168_30fps[0]),
	sizeof(sensor_imx576_setfile_B_1800X1800_30fps) / sizeof(sensor_imx576_setfile_B_1800X1800_30fps[0]),
	sizeof(sensor_imx576_setfile_B_4800X2700_30fps) / sizeof(sensor_imx576_setfile_B_4800X2700_30fps[0]),
	sizeof(sensor_imx576_setfile_B_4800X2336_30fps) / sizeof(sensor_imx576_setfile_B_4800X2336_30fps[0]),
	sizeof(sensor_imx576_setfile_B_3600X3600_30fps) / sizeof(sensor_imx576_setfile_B_3600X3600_30fps[0]),
};
...
static const struct sensor_pll_info_compact *sensor_imx576_pllinfos_B[] = {
	...
	&sensor_imx576_pllinfo_B_4800X3600_30fps,
	&sensor_imx576_pllinfo_B_2400X1800_30fps,
	&sensor_imx576_pllinfo_B_2400X1352_30fps,
	&sensor_imx576_pllinfo_B_2400X1168_30fps,
	&sensor_imx576_pllinfo_B_1800X1800_30fps,
	&sensor_imx576_pllinfo_B_4800X2700_30fps,
	&sensor_imx576_pllinfo_B_4800X2336_30fps,
	&sensor_imx576_pllinfo_B_3600X3600_30fps,
};
