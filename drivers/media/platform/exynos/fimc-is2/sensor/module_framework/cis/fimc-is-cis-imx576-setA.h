...
// Reference Version : 'IMX576-AAKH5_SAM-Set-26MHz-DPHY_RegisterSetting_ver4.00-9.00_MP_180807.xlsx'
...
const u32 sensor_imx576_setfile_A_ImageQuality[] = {
	//Image Quality adjustment setting
	0x4038, 0x00, 0x01,
	0x9856, 0xA0, 0x01,
	0x9857, 0x78, 0x01,
...
//[19] REG_B: Single Still Capture (4:3)   : 4800X3600@30
const u32 sensor_imx576_setfile_A_4800X3600_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[20] REG_B: Single Still Capture (4:3)   : 2400X1800@30
const u32 sensor_imx576_setfile_A_2400X1800_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[21] REG_B: Single Still Capture (4:3)   : 2400X1352@30
const u32 sensor_imx576_setfile_A_2400X1352_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[22] REG_B: Single Still Capture (4:3)   : 2400X1168@30
const u32 sensor_imx576_setfile_A_2400X1168_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[23] REG_B: Single Still Capture (4:3)   : 1800X1800@30
const u32 sensor_imx576_setfile_A_1800X1800_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
//[24] REG_B: Single Still Capture (4:3)   : 4800X2700@30
const u32 sensor_imx576_setfile_A_4800X2700_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
const u32 sensor_imx576_setfile_A_4800X2336_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
const u32 sensor_imx576_setfile_A_3600X3600_30fps[] = {
	//MIPI output setting
	0x0112, 0x0A, 0x01,
	0x0113, 0x0A, 0x01,
	0x0114, 0x03, 0x01,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_4800X3600_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_2400X1800_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_2400X1352_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_2400X1168_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_1800X1800_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	103350000 * 4,
	2180,
...
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_4800X2700_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
//[25]REG_Z: Single Still Capture (4:3): 4800X2336@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_4800X2336_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
//[26]REG_Z: Single Still Capture (4:3): 3600X3600@30
const struct sensor_pll_info_compact sensor_imx576_pllinfo_A_3600X3600_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	2054000000,
	198900000 * 4,
	4316,
...
static const u32 *sensor_imx576_setfiles_A[] = {
	...
	sensor_imx576_setfile_A_4800X3600_30fps,
	sensor_imx576_setfile_A_2400X1800_30fps,
	sensor_imx576_setfile_A_2400X1352_30fps,
	sensor_imx576_setfile_A_2400X1168_30fps,
	sensor_imx576_setfile_A_1800X1800_30fps,
	sensor_imx576_setfile_A_4800X2700_30fps,
	sensor_imx576_setfile_A_4800X2336_30fps,
	sensor_imx576_setfile_A_3600X3600_30fps,
};

static const u32 sensor_imx576_setfile_A_sizes[] = {
	sizeof(sensor_imx576_setfile_A_2X2BIN_2832x2124_30fps) / sizeof(sensor_imx576_setfile_A_2X2BIN_2832x2124_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2X2BIN_2832x1592_30fps) / sizeof(sensor_imx576_setfile_A_2X2BIN_2832x1592_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2X2BIN_2832x1376_30fps) / sizeof(sensor_imx576_setfile_A_2X2BIN_2832x1376_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2X2BIN_2124x2124_30fps) / sizeof(sensor_imx576_setfile_A_2X2BIN_2124x2124_30fps[0]),
	sizeof(sensor_imx576_setfile_A_QBCHDR_2832x2124_30fps) / sizeof(sensor_imx576_setfile_A_QBCHDR_2832x2124_30fps[0]),
	sizeof(sensor_imx576_setfile_A_QBCHDR_2832x1592_30fps) / sizeof(sensor_imx576_setfile_A_QBCHDR_2832x1592_30fps[0]),
	sizeof(sensor_imx576_setfile_A_QBCHDR_2832x1376_30fps) / sizeof(sensor_imx576_setfile_A_QBCHDR_2832x1376_30fps[0]),
	sizeof(sensor_imx576_setfile_A_QBCHDR_2124x2124_30fps) / sizeof(sensor_imx576_setfile_A_QBCHDR_2124x2124_30fps[0]),
	sizeof(sensor_imx576_setfile_A_5664x4248_30fps) / sizeof(sensor_imx576_setfile_A_5664x4248_30fps[0]),
	sizeof(sensor_imx576_setfile_A_5664x3184_30fps) / sizeof(sensor_imx576_setfile_A_5664x3184_30fps[0]),
	sizeof(sensor_imx576_setfile_A_5664x2752_30fps) / sizeof(sensor_imx576_setfile_A_5664x2752_30fps[0]),
	sizeof(sensor_imx576_setfile_A_4248x4248_30fps) / sizeof(sensor_imx576_setfile_A_4248x4248_30fps[0]),
	sizeof(sensor_imx576_setfile_A_1872x1052_240fps) / sizeof(sensor_imx576_setfile_A_1872x1052_240fps[0]),
	sizeof(sensor_imx576_setfile_A_1920x1080_120fps) / sizeof(sensor_imx576_setfile_A_1920x1080_120fps[0]),
	sizeof(sensor_imx576_setfile_A_1280x720_240fps) / sizeof(sensor_imx576_setfile_A_1280x720_240fps[0]),
	sizeof(sensor_imx576_setfile_A_1280x720_120fps) / sizeof(sensor_imx576_setfile_A_1280x720_120fps[0]),
	sizeof(sensor_imx576_setfile_A_2832x2124_117fps) / sizeof(sensor_imx576_setfile_A_2832x2124_117fps[0]),
	sizeof(sensor_imx576_setfile_A_2832x2124_60fps) / sizeof(sensor_imx576_setfile_A_2832x2124_60fps[0]),
	sizeof(sensor_imx576_setfile_A_2832x1592_120fps) / sizeof(sensor_imx576_setfile_A_2832x1592_120fps[0]),
	sizeof(sensor_imx576_setfile_A_4800X3600_30fps) / sizeof(sensor_imx576_setfile_A_4800X3600_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2400X1800_30fps) / sizeof(sensor_imx576_setfile_A_2400X1800_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2400X1352_30fps) / sizeof(sensor_imx576_setfile_A_2400X1352_30fps[0]),
	sizeof(sensor_imx576_setfile_A_2400X1168_30fps) / sizeof(sensor_imx576_setfile_A_2400X1168_30fps[0]),
	sizeof(sensor_imx576_setfile_A_1800X1800_30fps) / sizeof(sensor_imx576_setfile_A_1800X1800_30fps[0]),
	sizeof(sensor_imx576_setfile_A_4800X2700_30fps) / sizeof(sensor_imx576_setfile_A_4800X2700_30fps[0]),
	sizeof(sensor_imx576_setfile_A_4800X2336_30fps) / sizeof(sensor_imx576_setfile_A_4800X2336_30fps[0]),
	sizeof(sensor_imx576_setfile_A_3600X3600_30fps) / sizeof(sensor_imx576_setfile_A_3600X3600_30fps[0]),
};
...
static const struct sensor_pll_info_compact *sensor_imx576_pllinfos_A[] = {
	...
	&sensor_imx576_pllinfo_A_4800X3600_30fps,
	&sensor_imx576_pllinfo_A_2400X1800_30fps,
	&sensor_imx576_pllinfo_A_2400X1352_30fps,
	&sensor_imx576_pllinfo_A_2400X1168_30fps,
	&sensor_imx576_pllinfo_A_1800X1800_30fps,
	&sensor_imx576_pllinfo_A_4800X2700_30fps,
	&sensor_imx576_pllinfo_A_4800X2336_30fps,
	&sensor_imx576_pllinfo_A_3600X3600_30fps,
};
