...
#endif
		warn("sensor_3l2_check_rev is fail when cis init");
		cis->rev_flag = true;
		ret = 0;
	}
...
int sensor_3l2_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	max_setfile_num = sensor_3l2_max_setfile_num;
