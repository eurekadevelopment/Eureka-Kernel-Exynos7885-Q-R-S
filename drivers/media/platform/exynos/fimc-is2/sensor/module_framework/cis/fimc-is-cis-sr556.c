...
static const u32 *sensor_sr556_fsync_normal;
static u32 sensor_sr556_fsync_normal_size;
static const u32 *sensor_sr556_fsync_master;
static u32 sensor_sr556_fsync_master_size;
static const u32 *sensor_sr556_fsync_slave;
static u32 sensor_sr556_fsync_slave_size;
...
int sensor_sr556_cis_stream_on(struct v4l2_subdev *subdev)
{
	...
	case AA_CAMERATYPE_SINGLE:
		info("[%s]normal mode\n", __func__);
		ret = sensor_cis_set_registers(subdev, sensor_sr556_fsync_normal, sensor_sr556_fsync_normal_size);
		if (ret < 0)
			err("[%s] sensor_sr556_fsync_normal fail\n", __func__);
		break;
	case AA_CAMERATYPE_WIDE:
		info("[%s]master mode\n", __func__);
		ret = sensor_cis_set_registers(subdev, sensor_sr556_fsync_master, sensor_sr556_fsync_master_size);
		if (ret < 0)
			err("[%s] sensor_sr556_fsync_master fail\n", __func__);
		break;
	case AA_CAMERATYPE_TELE:
		info("[%s]slave mode\n", __func__);
		ret = sensor_cis_set_registers(subdev, sensor_sr556_fsync_slave, sensor_sr556_fsync_slave_size);
		if (ret < 0)
			err("[%s] sensor_sr556_fsync_slave fail\n", __func__);
		break;
	default:
...
static struct fimc_is_cis_ops cis_ops = {
	...
	.cis_wait_streamon = sensor_sr556_cis_wait_streamon,
};
	...
	const struct i2c_device_id *id)
{
	...
	if (strcmp(setfile, "default") == 0 ||
		...
		sensor_sr556_fsync_normal = sensor_sr556_setfile_A_Fsync_Normal;
		sensor_sr556_fsync_normal_size = sizeof(sensor_sr556_setfile_A_Fsync_Normal) / sizeof(sensor_sr556_setfile_A_Fsync_Normal[0]);
		sensor_sr556_fsync_master = sensor_sr556_setfile_A_Fsync_Master;
		sensor_sr556_fsync_master_size = sizeof(sensor_sr556_setfile_A_Fsync_Master) / sizeof(sensor_sr556_setfile_A_Fsync_Master[0]);
		sensor_sr556_fsync_slave = sensor_sr556_setfile_A_Fsync_Slave;
		sensor_sr556_fsync_slave_size = sizeof(sensor_sr556_setfile_A_Fsync_Slave) / sizeof(sensor_sr556_setfile_A_Fsync_Slave[0]);
		...
		sensor_sr556_fsync_normal = sensor_sr556_setfile_B_Fsync_Normal;
		sensor_sr556_fsync_normal_size = sizeof(sensor_sr556_setfile_B_Fsync_Normal) / sizeof(sensor_sr556_setfile_B_Fsync_Normal[0]);
		sensor_sr556_fsync_master = sensor_sr556_setfile_B_Fsync_Master;
