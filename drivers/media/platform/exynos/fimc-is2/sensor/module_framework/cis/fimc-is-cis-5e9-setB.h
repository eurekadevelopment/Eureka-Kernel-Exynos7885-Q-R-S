...
const u32 sensor_5e9_setfile_B_1296x972_60fps[] = {
	0x0136, 0x1A, 0x1,
	0x0137, 0x00, 0x1,
	0x0301, 0x06, 0x1,
	0x0305, 0x05, 0x1,
...
const u32 sensor_5e9_setfile_B_2560x1600_30fps[] = {
	0x0136,	0x1A, 0x1,
	0x0137,	0x00, 0x1,
	0x0301,	0x06, 0x1,
	0x0305,	0x05, 0x1,
...
const u32 sensor_5e9_setfile_B_1920x1080_30fps[] = {
	0x0136,	0x1A, 0x1,
	0x0137,	0x00, 0x1,
	0x0301,	0x06, 0x1,
	0x0305,	0x05, 0x1,
...
const struct sensor_pll_info sensor_5e9_pllinfo_B_1296x972_60fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x06, /* vt_pix_clk_div 	(0x0301) */
	0x01, /* vt_sys_clk_div 	(0x3C1C[7:4]) */
	0x05, /* pre_pll_clk_div	(0x0305) */
	...
	0x00, /* secnd_pre_pll_clk_div */
	0x00, /* secnd_pll_multiplier */
	0x03FA, /* frame_length_lines	(0x0340, 0x0341) */
	0x0C28, /* line_length_pck		(0x0342, 0x0343) */
};
...
const struct sensor_pll_info sensor_5e9_pllinfo_B_2560x1600_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x06, /* vt_pix_clk_div 	(0x0301) */
	0x01, /* vt_sys_clk_div 	(0x3C1C[7:4]) */
	0x05, /* pre_pll_clk_div	(0x0305) */
...
const struct sensor_pll_info sensor_5e9_pllinfo_B_1920x1080_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x06, /* vt_pix_clk_div 	(0x0301) */
	0x01, /* vt_sys_clk_div 	(0x3C1C[7:4]) */
	0x05, /* pre_pll_clk_div	(0x0305) */
...
static const u32 sensor_5e9_setfile_B_sizes[] = {
	...
	sizeof(sensor_5e9_setfile_B_1296x972_60fps) / sizeof(sensor_5e9_setfile_B_1296x972_60fps[0]),
	...
	sizeof(sensor_5e9_setfile_B_2560x1600_30fps) / sizeof(sensor_5e9_setfile_B_2560x1600_30fps[0]),
	...
	sizeof(sensor_5e9_setfile_B_1920x1080_30fps) / sizeof(sensor_5e9_setfile_B_1920x1080_30fps[0]),
