...
static struct fimc_is_sensor_cfg config_module_2x5[] = {
	...
	/* 0: 2880x2156@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2880, 2156,  30, 46,  0, CSI_DATA_LANES_4, 2093, 0, 0, 0),
	/* 1: 2880x1620@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2880, 1620,  30, 46,  1, CSI_DATA_LANES_4, 2093, 0, 0, 0),
	/* 2: 2880x1332@30fps */
...
static struct fimc_is_vci vci_module_2x5[] = {
	{
		...
		.config = {{0, HW_FORMAT_RAW10}, {1, HW_FORMAT_UNKNOWN}, {2, HW_FORMAT_EMBEDDED_8BIT}, {3, HW_FORMAT_UNKNOWN}}
	}, {
...
int sensor_module_2x5_probe(struct platform_device *pdev)
{
	...
	module->bitwidth = 10;
	module->vcis = ARRAY_SIZE(vci_module_2x5);
	module->vci = vci_module_2x5;
