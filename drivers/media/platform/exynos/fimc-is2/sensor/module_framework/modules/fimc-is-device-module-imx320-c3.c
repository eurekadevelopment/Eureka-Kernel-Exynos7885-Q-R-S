...
int sensor_module_imx320_c3_probe(struct platform_device *pdev)
{
	int ret = 0;
...
static int sensor_module_imx320_c3_remove(struct platform_device *pdev)
{
	int ret = 0;
...
static struct platform_driver sensor_module_imx320_c3_driver = {
	.probe  = sensor_module_imx320_c3_probe,
	.remove = sensor_module_imx320_c3_remove,
	.driver = {
...
module_platform_driver(sensor_module_imx320_c3_driver);
