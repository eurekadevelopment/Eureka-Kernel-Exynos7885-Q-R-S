...
#define SHADING_CRC32_LEN                               (6640)

/***** SENSOR CAL Referenced section *****/
#define EEP_AP_SENSOR_CAL_START_ADDR                    0x2200
#define EEP_CHECKSUM_SENSOR_CAL_ADDR                    0x221C
#define SENSOR_CAL_CRC32_LEN                            (1456)

/***** DUAL DATA Referenced section *****/
#define EEP_DUAL_DATA_VER_START_ADDR                    0x2680
#define EEP_CHECKSUM_DUAL_DATA_ADDR                     0x269C
#define DUAL_DATA_CRC32_LEN                             (64)
