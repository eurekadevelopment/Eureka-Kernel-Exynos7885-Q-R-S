...
#define EEP_HEADER_MODULE_ID_ADDR_FRONT                 0xA0
#define EEP_HEADER_SENSOR_ID_ADDR_FRONT                 0xB0
#define EEP_HEADER_MTF_DATA_ADDR_FRONT                  0x40

/* OEM referenced section */
#define EEP_OEM_VER_START_ADDR_FRONT                    0x1E0
#define EEP_CHECKSUM_OEM_BASE_ADDR_FRONT                0x190
...
#define HEADER_CRC32_LEN_FRONT                          (208)
#define OEM_CRC32_LEN_FRONT                             (48)
#define AWB_CRC32_LEN_FRONT                             (32)
#define SHADING_CRC32_LEN_FRONT                         (5000)
