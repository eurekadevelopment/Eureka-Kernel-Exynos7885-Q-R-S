#ifndef FIMC_IS_VENDOR_CONFIG_AAS_V10EKX_H
#define FIMC_IS_VENDOR_CONFIG_AAS_V10EKX_H
...
#define DDK_USE_SMALL_MEMORY                       /* DDK reduce memory for 2GB product */
...
#endif /* FIMC_IS_VENDOR_CONFIG_A10E */
