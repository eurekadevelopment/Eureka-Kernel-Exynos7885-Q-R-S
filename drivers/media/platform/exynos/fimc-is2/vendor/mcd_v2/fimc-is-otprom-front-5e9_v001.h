...
const struct fimc_is_vender_rom_addr front_5e9_otp_cal_addr = {
	...
	0x34,			//int32_t		rom_header_main_module_info_start_addr;
	0x54,			//int32_t		rom_header_cal_map_ver_start_addr;
	0x5C,			//int32_t		rom_header_project_name_start_addr;
	0xBA,			//int32_t		rom_header_module_id_addr;
	0xC4,			//int32_t		rom_header_main_sensor_id_addr;
	...
	0x08,			//int32_t		rom_header_main_oem_end_addr;
	0x10,			//int32_t		rom_header_main_awb_start_addr;
	0x18,			//int32_t		rom_header_main_awb_end_addr;
	...
	0x74,			//int32_t		rom_header_mtf_data_addr;
	-1,			//int32_t		rom_header_sub_mtf_data_addr;

	0xF0,			//int32_t		rom_header_checksum_addr;
	(240),			//int32_t		rom_header_checksum_len;

	0xF4,			//int32_t		rom_oem_af_inf_position_addr;
	0xFC,			//int32_t		rom_oem_af_macro_position_addr;
	0x0154,			//int32_t		rom_oem_module_info_start_addr;
	0x0170,			//int32_t		rom_oem_checksum_addr;
	(96),			//int32_t		rom_oem_checksum_len;

	0x1B4,			//int32_t		rom_awb_module_info_start_addr;
	0x1E0,			//int32_t		rom_awb_checksum_addr;
	(64),			//int32_t		rom_awb_checksum_len;
