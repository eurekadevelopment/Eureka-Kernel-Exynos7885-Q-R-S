...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_HD_120FPS = 27,
	ISS_SUB_SCENARIO_HD_240FPS = 53,
	...
	ISS_SUB_SCENARIO_VIDEO_SW_VDIS = 48,			/* 48: SW VDIS Recording */
	ISS_SUB_SCENARIO_VIDEO_SW_VDIS_WDR_AUTO = 51,		/* 51: Single video (HDR Auto) : up to FHD 30fps, VDIS */
	ISS_SUB_SCENARIO_VIDEO_SW_VDIS_WDR_ON   = 52,		/* 52: Single video (HDR On)   : up to FHD 30fps, VDIS */
	...
	ISS_SUB_SCENARIO_FRONT_REMOSAIC_CAPTURE = 47,		/* 47: front camera Remosaic capture */
	ISS_SUB_SCENARIO_FRONT_REMOSAIC_CAPTURE_WDR_AUTO = 49,	/* 49: front camera Remosaic capture+WDR Auto */
	ISS_SUB_SCENARIO_FRONT_REMOSAIC_CAPTURE_WDR_ON = 50,	/* 50: front camera Remosaic capture+WDR On */
