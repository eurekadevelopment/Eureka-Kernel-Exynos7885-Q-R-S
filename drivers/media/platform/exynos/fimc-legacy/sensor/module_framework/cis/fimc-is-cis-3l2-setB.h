...
/* Reference: 3L2_EVT1.1_26Mhz_20180109.xlsx */
...
/* 4144 x 2016 @30 */
const u32 sensor_3l2_setfile_B_4144x2016_30fps[] = {
	0x0136, 0x1A00, 0x02,
	0x0104, 0x0100, 0x02,
	0x0112, 0x0A0A, 0x02,
	0x0500, 0x0000, 0x02,
...
/* 2072 x 1162 @30 */
const u32 sensor_3l2_setfile_B_2072x1162_30fps[] = {
	0x0136, 0x1A00, 0x02,
	0x0104, 0x0100, 0x02,
	0x0112, 0x0A0A, 0x02,
	0x0500, 0x0000, 0x02,
...
/* 2072 x 1008 @30 */
const u32 sensor_3l2_setfile_B_2072x1008_30fps[] = {
	0x0136, 0x1A00, 0x02,
	0x0104, 0x0100, 0x02,
	0x0112, 0x0A0A, 0x02,
	0x0500, 0x0000, 0x02,
...
const struct sensor_pll_info sensor_3l2_pllinfo_B_4144x2016_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x02, /* vt_pix_clk_div	(0x0301) */
	0x01, /* vt_sys_clk_div	(0x0303) */
	0x06, /* pre_pll_clk_div	(0x0305) */
...
const struct sensor_pll_info sensor_3l2_pllinfo_B_2072x1552_15fps = {
	...
	0x06, /* secnd_pre_pll_clk_div	(0x030D) */
	0xFD, /* secnd_pll_multiplier	(0x030F) */
	0x11BC, /* frame_length_lines	(0x0341) */
	0x11A0, /* line_length_pck	(0x0343) */
};

const struct sensor_pll_info sensor_3l2_pllinfo_B_2072x1162_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x02, /* vt_pix_clk_div	(0x0301) */
	0x01, /* vt_sys_clk_div	(0x0303) */
	0x06, /* pre_pll_clk_div	(0x0305) */
...
const struct sensor_pll_info sensor_3l2_pllinfo_B_2072x1008_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x02, /* vt_pix_clk_div	(0x0301) */
	0x01, /* vt_sys_clk_div	(0x0303) */
	0x06, /* pre_pll_clk_div	(0x0305) */
...
static const u32 *sensor_3l2_setfiles_B[] = {
	...
	sensor_3l2_setfile_B_4144x2016_30fps,
	sensor_3l2_setfile_B_2072x1552_30fps,
	sensor_3l2_setfile_B_2072x1552_15fps,
	sensor_3l2_setfile_B_2072x1162_30fps,
	sensor_3l2_setfile_B_2072x1166_60fps,
	sensor_3l2_setfile_B_2072x1008_30fps,
...
static const u32 sensor_3l2_setfile_B_sizes[] = {
	...
	sizeof(sensor_3l2_setfile_B_4144x2016_30fps) / sizeof(sensor_3l2_setfile_B_4144x2016_30fps[0]),
	...
	sizeof(sensor_3l2_setfile_B_2072x1162_30fps) / sizeof(sensor_3l2_setfile_B_2072x1162_30fps[0]),
	sizeof(sensor_3l2_setfile_B_2072x1166_60fps) / sizeof(sensor_3l2_setfile_B_2072x1166_60fps[0]),
	sizeof(sensor_3l2_setfile_B_2072x1008_30fps) / sizeof(sensor_3l2_setfile_B_2072x1008_30fps[0]),	
...
static const struct sensor_pll_info *sensor_3l2_pllinfos_B[] = {
	...
	&sensor_3l2_pllinfo_B_4144x2016_30fps,
	&sensor_3l2_pllinfo_B_2072x1552_30fps,
	&sensor_3l2_pllinfo_B_2072x1552_15fps,
	&sensor_3l2_pllinfo_B_2072x1162_30fps,
	&sensor_3l2_pllinfo_B_2072x1166_60fps,
	&sensor_3l2_pllinfo_B_2072x1008_30fps,
