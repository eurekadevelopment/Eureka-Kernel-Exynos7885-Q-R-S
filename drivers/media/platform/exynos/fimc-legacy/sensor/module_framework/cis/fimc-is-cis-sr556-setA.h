...
const u32 sensor_sr556_setfile_A_2592x1944_30fps[] = {
	0x0b0a, 0x8252, 0x02,
	0x0f30, 0x8435, 0x02,
	0x0f32, 0x7067, 0x02,
	0x004a, 0x0100, 0x02,
...
const u32 sensor_sr556_setfile_A_1296x972_30fps[] = {
	0x0b0a, 0x8259, 0x02,
	0x0f30, 0x8435, 0x02,
	0x0f32, 0x7167, 0x02,
	0x004a, 0x0100, 0x02,
...
const u32 sensor_sr556_setfile_A_1296x972_15fps[] = {
	0x0b0a, 0x8259, 0x02,
	0x0f30, 0x8435, 0x02,
	0x0f32, 0x7167, 0x02,
	0x004a, 0x0100, 0x02,
...
const u32 sensor_sr556_setfile_A_1296x972_7fps[] = {
	0x0b0a, 0x8259, 0x02,
	0x0f30, 0x8435, 0x02,
	0x0f32, 0x7167, 0x02,
	0x004a, 0x0100, 0x02,
...
const u32 sensor_sr556_setfile_A_648x484_120fps[] = {
	0x0b0a, 0x8252, 0x02,
	0x0f30, 0x8435, 0x02,
	0x0f32, 0x7267, 0x02,
	0x004a, 0x0100, 0x02,
...
const struct sensor_pll_info sensor_sr556_pllinfo_A_2592x1944_30fps = {
...
const struct sensor_pll_info sensor_sr556_pllinfo_A_1296x972_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x01, /* vt_pix_clk_div    */
	0x0a, /* vt_sys_clk_div    */
	0x04, /* pre_pll_clk_div   (0x0F32: PLL_prediv_ramp) */
...
const struct sensor_pll_info sensor_sr556_pllinfo_A_1296x972_15fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x01, /* vt_pix_clk_div    */
	0x0a, /* vt_sys_clk_div    */
	0x04, /* pre_pll_clk_div   (0x0F32: PLL_prediv_ramp) */
...
const struct sensor_pll_info sensor_sr556_pllinfo_A_1296x972_7fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x01, /* vt_pix_clk_div    */
	0x0a, /* vt_sys_clk_div    */
	0x04, /* pre_pll_clk_div   (0x0F32: PLL_prediv_ramp) */
...
const struct sensor_pll_info sensor_sr556_pllinfo_A_648x484_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x01, /* vt_pix_clk_div */
	0x0a, /* vt_sys_clk_div */
	0x04, /* pre_pll_clk_div */
...
static const u32 *sensor_sr556_setfiles_A[] = {
	sensor_sr556_setfile_A_2592x1944_30fps,
	sensor_sr556_setfile_A_2560x1440_30fps,
	sensor_sr556_setfile_A_1296x972_30fps,
	sensor_sr556_setfile_A_1296x972_15fps,
	sensor_sr556_setfile_A_1296x972_7fps,
	sensor_sr556_setfile_A_648x484_120fps,
};

static const u32 sensor_sr556_setfile_A_sizes[] = {
	sizeof(sensor_sr556_setfile_A_2592x1944_30fps) / sizeof(sensor_sr556_setfile_A_2592x1944_30fps[0]),
	sizeof(sensor_sr556_setfile_A_2560x1440_30fps) / sizeof(sensor_sr556_setfile_A_2560x1440_30fps[0]),
	sizeof(sensor_sr556_setfile_A_1296x972_30fps) / sizeof(sensor_sr556_setfile_A_1296x972_30fps[0]),
	sizeof(sensor_sr556_setfile_A_1296x972_15fps) / sizeof(sensor_sr556_setfile_A_1296x972_15fps[0]),
	sizeof(sensor_sr556_setfile_A_1296x972_7fps) / sizeof(sensor_sr556_setfile_A_1296x972_7fps[0]),
	sizeof(sensor_sr556_setfile_A_648x484_120fps) / sizeof(sensor_sr556_setfile_A_648x484_120fps[0]),
};

static const struct sensor_pll_info *sensor_sr556_pllinfos_A[] = {
	&sensor_sr556_pllinfo_A_2592x1944_30fps,
	&sensor_sr556_pllinfo_A_2560x1440_30fps,
	&sensor_sr556_pllinfo_A_1296x972_30fps,
	&sensor_sr556_pllinfo_A_1296x972_15fps,
	&sensor_sr556_pllinfo_A_1296x972_7fps,
	&sensor_sr556_pllinfo_A_648x484_120fps,
};
