...
int sensor_module_4e6_c2_probe(struct platform_device *pdev)
{
	int ret = 0;
...
static int sensor_module_4e6_c2_remove(struct platform_device *pdev)
{
	int ret = 0;
...
static struct platform_driver sensor_module_4e6_c2_driver = {
	.probe  = sensor_module_4e6_c2_probe,
	.remove = sensor_module_4e6_c2_remove,
	.driver = {
...
module_platform_driver(sensor_module_4e6_c2_driver);
