...
#else
		/* Temp: get rear finfo until enable rear3 eeprom. */
		*finfo = &sysfs_finfo;
#endif
		break;
	case SENSOR_POSITION_FRONT:
...
bool fimc_is_sec_check_rear_cal_crc32(char *buf, int position)
{
...
#endif
#endif /* CAMERA_REAR2 */
#endif /* defined(CONFIG_COMPANION_C3_USE) */
	...
	checksum = 0;
#if defined(AP_PDAF_CRC32_LEN)
	check_length = AP_PDAF_CRC32_LEN;
#else
...
crc_retry:
	...
	if (position == SENSOR_POSITION_FRONT || position == SENSOR_POSITION_FRONT2) {
		...
		memcpy(finfo->from_module_id, &buf[EEP_HEADER_MODULE_ID_ADDR_REAR2], FIMC_IS_MODULE_ID_SIZE);
#else
	...
	if (IS_ERR(key_fp)) {
		...
		if (IS_ERR(dump_fp)) {
			...
			if (position == SENSOR_POSITION_REAR
#if !defined(CONFIG_CAMERA_EEPROM_SUPPORT_REAR2)
				 || position == SENSOR_POSITION_REAR2
#endif
) {
...
#if defined(CONFIG_CAMERA_EEPROM_SUPPORT_REAR2)
			if (position == SENSOR_POSITION_REAR2) {
				if (write_data_to_file("/data/media/0/dump/eeprom_rear2_cal.bin", buf, cal_size, &pos) < 0) {
					info("Failed to rear dump cal data.\n");
					goto dump_err;
				}
			} else
...
p_err:
	...
	|| defined(CONFIG_CAMERA_OTPROM_SUPPORT_FRONT) || defined(CONFIG_CAMERA_EEPROM_SUPPORT_REAR2)
...
#else
			if (fimc_is_sec_ldo_enabled(dev, "VDDIO_1.8V_VT") <= 0) {
				fimc_is_sec_rom_power_on(core, SENSOR_POSITION_FRONT);
				is_ldo_enabled[0] = true;
			}
...
int fimc_is_sec_concord_fw_sel(struct fimc_is_core *core, struct device *dev)
{
	...
	if ((!sysfs_finfo.is_c1_caldata_read &&
...
#ifdef ENABLE_IMX260
		if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_IMX260_D)) {
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX260);
		...
		} else if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_COMP_IMX260_IMX320)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX260_IMX320);
			snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_IMX260_IMX320), "%s", FIMC_IS_FW_COMPANION_IMX260_IMX320);
			snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_IMX260_MASTER_SETF), "%s", FIMC_IS_COMPANION_IMX260_MASTER_SETF);
			snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_IMX260_MODE_SETF), "%s", FIMC_IS_COMPANION_IMX260_MODE_SETF);
		} else
#endif
		if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_2L1_C)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_2L1);
		...
		} else if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_COMP_IMX333_IMX320)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX333_IMX320);
		...
		} else if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_COMP_IMX333_3H1)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX333_3H1);
			snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_IMX333_3H1), "%s", FIMC_IS_FW_COMPANION_IMX333_3H1);
			snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MASTER_SETF), "%s", FIMC_IS_COMPANION_IMX333_MASTER_SETF);
			snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MODE_SETF), "%s", FIMC_IS_COMPANION_IMX333_MODE_SETF);
		} else if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_COMP_2L2_IMX320)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_2L2_IMX320);
		...
		} else if (fimc_is_sec_fw_module_compare(sysfs_finfo.concord_header_ver, FW_COMP_2L2_3H1)){
			snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_2L2_3H1);
			...
			if (specific->rear_sensor_id == SENSOR_NAME_IMX260) {
				snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX260);
				snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_IMX260), "%s", FIMC_IS_FW_COMPANION_IMX260);
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_IMX260_MASTER_SETF), "%s", FIMC_IS_COMPANION_IMX260_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_IMX260_MODE_SETF), "%s", FIMC_IS_COMPANION_IMX260_MODE_SETF);
				...
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_2L1_MASTER_SETF), "%s", FIMC_IS_COMPANION_2L1_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_2L1_MODE_SETF), "%s", FIMC_IS_COMPANION_2L1_MODE_SETF);
			} else if (specific->rear_sensor_id == SENSOR_NAME_IMX333 && specific->front_sensor_id == SENSOR_NAME_IMX320) {
				snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX333_IMX320);
				snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_IMX333_IMX320), "%s", FIMC_IS_FW_COMPANION_IMX333_IMX320);
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MASTER_SETF), "%s", FIMC_IS_COMPANION_IMX333_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MODE_SETF), "%s", FIMC_IS_COMPANION_IMX333_MODE_SETF);
			} else if (specific->rear_sensor_id == SENSOR_NAME_IMX333 && specific->front_sensor_id == SENSOR_NAME_S5K3H1) {
				snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_IMX333_3H1);
				snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_IMX333_3H1), "%s", FIMC_IS_FW_COMPANION_IMX333_3H1);
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MASTER_SETF), "%s", FIMC_IS_COMPANION_IMX333_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_IMX333_MODE_SETF), "%s", FIMC_IS_COMPANION_IMX333_MODE_SETF);
			} else if (specific->rear_sensor_id == SENSOR_NAME_S5K2L2 && specific->front_sensor_id == SENSOR_NAME_IMX320) {
				snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_2L2_IMX320);
				snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_2L2_IMX320), "%s", FIMC_IS_FW_COMPANION_2L2_IMX320);
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_2L2_MASTER_SETF), "%s", FIMC_IS_COMPANION_2L2_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_2L2_MODE_SETF), "%s", FIMC_IS_COMPANION_2L2_MODE_SETF);
			} else if (specific->rear_sensor_id == SENSOR_NAME_S5K2L2 && specific->front_sensor_id == SENSOR_NAME_S5K3H1) {
				snprintf(c1_fw_path, sizeof(c1_fw_path), "%s%s", FIMC_IS_FW_PATH, FIMC_IS_FW_COMPANION_2L2_3H1);
				snprintf(sysfs_finfo.load_c1_fw_name, sizeof(FIMC_IS_FW_COMPANION_2L2_3H1), "%s", FIMC_IS_FW_COMPANION_2L2_3H1);
				snprintf(sysfs_finfo.load_c1_mastersetf_name, sizeof(FIMC_IS_COMPANION_2L2_MASTER_SETF), "%s", FIMC_IS_COMPANION_2L2_MASTER_SETF);
				snprintf(sysfs_finfo.load_c1_modesetf_name, sizeof(FIMC_IS_COMPANION_2L2_MODE_SETF), "%s", FIMC_IS_COMPANION_2L2_MODE_SETF);
