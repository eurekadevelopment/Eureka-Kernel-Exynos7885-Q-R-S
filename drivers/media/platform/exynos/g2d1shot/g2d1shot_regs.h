...
#define G2D_LAYERn_IMAGE_WIDTH_REG(n)		LAYER_SET(n, IMAGE_WIDTH)
#define G2D_LAYERn_IMAGE_HEIGHT_REG(n)		LAYER_SET(n, IMAGE_HEIGHT)
#define G2D_LAYERn_PLANE2_BASE_ADDR_REG(n)	LAYER_SET(n, PLANE2_BASE_ADDR)
#define G2D_LAYERn_YCBCR_MODE_REG(n)		LAYER_SET(n, YCBCR_MODE)
...
#define G2D_DST_HEADER_BASE_ADDR_REG		(0x150)
#define G2D_DST_PAYLOAD_BASE_ADDR_REG		(0x154)
#define G2D_DST_IMAGE_WIDTH_REG		(0x160)
#define G2D_DST_IMAGE_HEIGHT_REG		(0x164)
#define G2D_DST_PLANE2_BASE_ADDR_REG		(0x170)
#define G2D_DST_PLANE3_BASE_ADDR_REG		(0x174)
#define G2D_DST_YCBCR_MODE_REG			(0x178)
#define G2D_DST_CSC_COEFF00_REG		(0xb00)
...
#define G2D_LAYER0_IMAGE_WIDTH_REG		(0x270)
#define G2D_LAYER0_IMAGE_HEIGHT_REG		(0x274)
#define G2D_LAYER0_PLANE2_BASE_ADDR_REG	(0x280)
#define G2D_LAYER0_YCBCR_MODE_REG		(0x288)
...
/* 7. Layer CSC Coefficient */
#define CSC_OFFSET(n)				((0x24) * (n))
#define G2D_LAYER_CSCn_COEFF00_REG(n)		(G2D_LAYER_CSC0_COEFF00_REG + CSC_OFFSET(n))
#define G2D_LAYER_CSC0_COEFF00_REG		(0xa00)
#define G2D_LAYER_CSC0_COEFF10_REG		(0xa04)
...
#define G2D_COMP_DEBUG_CLUSTER0			(0 << 5)
#define G2D_COMP_DEBUG_CLUSTER1			(1 << 5)
...
/* G2D_DST_YCBCR_MODE_REG */
#define G2D_DST_YCBCR_RANGE_OFFSET_Y		(12)
#define G2D_DST_YCBCR_RANGE_OFFSET_X		(8)
#define G2D_DST_YCBCR_RANGE_SHIFT		(4)
#define G2D_DST_CSC_DITHER_EN		(2)
...
#define G2D_PREMULT_GLOBAL_ALPHA		(0x2 << 24)
...
#define G2D_LAYER_UORDER_ADDR			(1 << 21)
...
#define G2D_LAYER_SCALE_MODE_NEAREST		(1 << 0)
...
/* G2D_LAYERn_YCBCR_MODE_REG */
#define G2D_LAYER_YCBCR_RANGE_OFFSET_Y		(12)
#define G2D_LAYER_YCBCR_RANGE_OFFSET_X		(8)
#define G2D_LAYER_YCBCR_RANGE_SHIFT		(4)

/* G2D_DST_SPLIT_TILE_IDX_REG */
