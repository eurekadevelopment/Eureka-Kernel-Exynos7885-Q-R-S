...
static struct pwrcal_clk *disp0_mux_sclk_disp0_decon0_eclk0_p[] = {	CLK(DISP0_MUX_SCLK_DISP0_DECON0_ECLK0_USER),	CLK(OSCCLK),	CLK(DISP0_MUX_DISP_PLL),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY0_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY1_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY2_BITCLKDIV2_USER)	};
static struct pwrcal_clk *disp0_mux_sclk_disp0_decon0_vclk0_p[] = {	CLK(DISP0_MUX_SCLK_DISP0_DECON0_VCLK0_USER),	CLK(OSCCLK),	CLK(DISP0_MUX_DISP_PLL),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY0_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY1_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY2_BITCLKDIV2_USER)	};
static struct pwrcal_clk *disp0_mux_sclk_disp0_decon0_vclk1_p[] = {	CLK(DISP0_MUX_SCLK_DISP0_DECON0_VCLK1_USER),	CLK(OSCCLK),	CLK(DISP0_MUX_DISP_PLL),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY0_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY1_BITCLKDIV2_USER),	CLK(DISP0_MUX_PHYCLK_MIPIDPHY2_BITCLKDIV2_USER)	};
