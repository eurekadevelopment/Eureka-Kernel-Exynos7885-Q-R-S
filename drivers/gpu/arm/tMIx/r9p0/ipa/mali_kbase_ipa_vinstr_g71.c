		...
		u32 offset)
{
	...
	counter = kbase_g71_power_model_get_memsys_counter(model_data, offset);
    ...
    u32 counter_block_offset)
{
	...
	counter = kbase_g71_power_model_get_sc_counter(model_data,
    ...
    u32 counter_block_offset)
{
	...
	counter = kbase_g71_power_model_get_jm_counter(model_data,
			counter_block_offset);
	return kbase_ipa_single_counter(model_data, coeff, counter);
}
