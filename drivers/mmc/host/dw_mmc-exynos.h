...
/* CMU debugging */
#define MMC_CLK_BASE			0x13400000
#define QCH_CON_MMC_EMBD_QCH		0x301c
#define MMC_CLK_STATUS			0x701c
#define FSYS_CMU_CONTROL_OPTION		0x800
