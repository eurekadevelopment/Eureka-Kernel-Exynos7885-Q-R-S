...
int exynos7885_secgpio_get_nr_gpio(void)
{
	int i, j;
	int nr_gpio = 0;

	for (i = 0; i < ARRAY_SIZE(exynos7885_pin_ctrl); i++) {
		for(j = 0; j < exynos7885_pin_ctrl[i].nr_banks; j++)
			nr_gpio += exynos7885_pin_ctrl[i].pin_banks[j].nr_pins;
	}
