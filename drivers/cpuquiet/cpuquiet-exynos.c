...
#define EXYNOS_AVG_HOTPLUG_LATENCY_MS 2

static struct cpuquiet_platform_info msm_plat_info = {
	.plat_name = "exynos-cpuquiet",
	.avg_hotplug_latency_ms = EXYNOS_AVG_HOTPLUG_LATENCY_MS,
};
